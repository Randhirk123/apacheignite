...
public class IgniteConfigurationHelper {
     ...
     * Enforces singleton.
     */
    private IgniteConfigurationHelper() {
        // No-op.
    }
    ...
    public static void setDaemon(boolean daemon) {
        IgniteConfigurationHelper.daemon.set(daemon);
    }
    ...
    public static void setClientMode(boolean clientMode) {
        IgniteConfigurationHelper.clientMode.set(clientMode);
    }
    ...
    /**
     * Behavior of the method is the almost same as {@link IgniteConfigurationHelper#stop(String, boolean, boolean)}.
